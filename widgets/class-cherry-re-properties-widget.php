...
class Cherry_RE_Properties_Widget extends Cherry_Abstract_Widget {
	...
	public function __construct() {
		...
		$this->settings = array(
			...
			'ids' => array(
				'type'        => 'text',
				'value'       => '',
				'label'       => esc_html__( 'Type posts ID:', 'cherry-real-esate' ),
	...
	public function widget( $args, $instance ) {
		...
		$query_args = array(
			...
			'css_class'        => 'tm_property--widget list', // grid
		);
		...
		$query_args = apply_filters( 'cherry_re_properties_widget_args', $query_args );
